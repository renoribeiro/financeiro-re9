...
export interface Database {
  ...
  public: {
    Tables: {
      ...
      receivables: {
        Row: { account: string | null; amount: number; category_id: string | null; client_document: string | null; client_name: string | null; commission_installment_id: string | null; company_id: string; competence_date: string | null; cost_center_id: string | null; created_at: string; description: string; due_date: string; id: string; invoice_rule: string; notes: string | null; proof_url: string | null; received_at: string | null; recurrence: string; sale_id: string | null; status: string; updated_at: string }
        Insert: { account?: string | null; amount: number; category_id?: string | null; client_document?: string | null; client_name?: string | null; commission_installment_id?: string | null; company_id: string; competence_date?: string | null; cost_center_id?: string | null; created_at?: string; description: string; due_date: string; id?: string; invoice_rule?: string; notes?: string | null; proof_url?: string | null; received_at?: string | null; recurrence?: string; sale_id?: string | null; status?: string; updated_at?: string }
        Update: { account?: string | null; amount?: number; category_id?: string | null; client_document?: string | null; client_name?: string | null; commission_installment_id?: string | null; company_id?: string; competence_date?: string | null; cost_center_id?: string | null; created_at?: string; description?: string; due_date?: string; id?: string; invoice_rule?: string; notes?: string | null; proof_url?: string | null; received_at?: string | null; recurrence?: string; sale_id?: string | null; status?: string; updated_at?: string }
        Relationships: []
      }
      sales: {
        Row: { broker_id: string | null; buyer_contact: string | null; buyer_document: string | null; buyer_name: string | null; commission_amount_override: number | null; commission_calculation_mode: string; commission_percentage: number; company_id: string; created_at: string; development_commission_percentage_snapshot: number | null; development_id: string | null; id: string; notes: string | null; payment_method: string | null; sale_date: string | null; sale_value: number; status: string; unit: string | null; updated_at: string }
        Insert: { broker_id?: string | null; buyer_contact?: string | null; buyer_document?: string | null; buyer_name?: string | null; commission_amount_override?: number | null; commission_calculation_mode?: string; commission_percentage?: number; company_id: string; created_at?: string; development_commission_percentage_snapshot?: number | null; development_id?: string | null; id?: string; notes?: string | null; payment_method?: string | null; sale_date?: string | null; sale_value?: number; status?: string; unit?: string | null; updated_at?: string }
        Update: { broker_id?: string | null; buyer_contact?: string | null; buyer_document?: string | null; buyer_name?: string | null; commission_amount_override?: number | null; commission_calculation_mode?: string; commission_percentage?: number; company_id?: string; created_at?: string; development_commission_percentage_snapshot?: number | null; development_id?: string | null; id?: string; notes?: string | null; payment_method?: string | null; sale_date?: string | null; sale_value?: number; status?: string; unit?: string | null; updated_at?: string }
        Relationships: []
      }
      suppliers: {
