...
// Este projeto é ESM (`"type": "module"`), então `require`/`__dirname` não
// existem no escopo. Recriamos ambos a partir de import.meta para o script
// funcionar tanto local quanto no build do container (Docker/Dokploy).
